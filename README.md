...
| 3. MySQL setup development | [setup_mysql_dev.sql](https://github.com/Theemiss/AirBnB_clone_v2/blob/master/setup_mysql_dev.sql) | Ceate a database and user and grant privileges to user on tha database for the development|
